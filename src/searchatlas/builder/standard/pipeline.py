...
def main():
    ...
    from .evidence import build_constructed_url_pk_edges, extract_query_docs
    ...
    for task in tasks:
        ...
        qid_doc, turn_thinks, result_counts, qid_search_doc, turn_url_owners, visit_summary_hard_failures, query_url_metadata, visit_match_log, turn_contexts = extract_query_docs(messages, turn_to_qids, qid_to_text)
        ...
        if answer_text:
            ...
            if answer_units_list:
                ...
                q_coverage = answer_signal_provenance_matching(answer_signals=answer_signals_list, queries=queries, qid_doc=qid_doc, question=question, answer_support_text=answer_support_text, sent_window=3)
